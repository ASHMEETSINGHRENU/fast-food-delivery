<?php
    ...
    if(isset($_POST["updateProfileDetail"])){
        ...
        if (password_verify($password, $passRow['password'])){ 
            $sql = "UPDATE `tbl_users` SET `firstName` = '$firstName', `lastName` = '$lastName', `email` = '$email', `phone` = '$phone' WHERE `id` ='$userId'";   
    ...
    if(isset($_POST["removeProfilePic"])){
        $filename = $_SERVER['DOCUMENT_ROOT']."/food-ordering-system/img/person-".$userId.".jpg";
