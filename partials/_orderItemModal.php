                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <?php
                                    $mysql = "SELECT * FROM `tbl_orderitems` WHERE orderId = $orderid";
                                    $myresult = mysqli_query($conn, $mysql);
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        $foodId = $myrow['foodId'];
                                        $itemQuantity = $myrow['itemQuantity'];
                                        
                                        $itemsql = "SELECT * FROM `tbl_food` WHERE id = $foodId";
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="img/item-'.$foodId. '.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle">'.$itemName. '</a></h5><span class="text-muted font-weight-normal font-italic d-block">Rs. ' .$price. '/-</span>
                                                    </div>
                                                    </div>
                                                </th>
