...
<?php 
    $statusmodalsql = "SELECT * FROM `tbl_orders` WHERE `userId`= $userId";
                        ...
                        <div class="card-body">
                            ...
                            <article class="card">
                                <div class="card-body row">
                                    <div class="col"> <strong>Estimated Delivery time:</strong> <br><?php if(!empty($deliveryTime))echo $deliveryTime; ?> minute </div>
                                    <div class="col"> <strong>Shipping By:</strong> <br> <?php if(!empty($deliveryBoyName)) echo $deliveryBoyName; ?> | <i class="fa fa-phone"></i> <?php if(!empty($deliveryBoyPhoneNo)) echo $deliveryBoyPhoneNo; ?> </div>
                                    <div class="col"> <strong>Status:</strong> <br> <?php echo $tstatus; ?> </div>
                                    <div class="col"> <strong>Tracking #:</strong> <br> <?php if(!empty($trackId)) echo $trackId; ?> </div>
                                </div>
                            </article>
                            <div class="track">
                            <?php
