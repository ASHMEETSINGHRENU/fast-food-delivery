...
<div class="cart-section mt-150 mb-150">
    ...
    <?php 
        ...
        <div class="alert alert-info my-3">
            <font style="font-size:22px"><center>Check your Order. You need to <strong><a style="color:#f28123"; data-toggle="modal" data-target="#loginModal">Login</a></strong></center></font>
        </div></div></div>';
    }
    ?>
